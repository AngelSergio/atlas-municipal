/**
 * Configuración del municipio — VILLAGRÁN, GUANAJUATO (starter)
 * ---------------------------------------------------------------
 * Archivo de arranque generado para la presentación / despliegue de Villagrán.
 * Para usarlo: en la carpeta de despliegue de Villagrán, copiar este archivo
 * como  municipio.config.js  (que está en .gitignore, uno por instalación).
 *
